...
venue: "ACENET: Programming Workshop: Unix Shell, Version Control and Python "        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
collaborative_notes: "https://pad.carpentries.org/2021-05-06-ACENET_SWC-P"  # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite: "135705937111"          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
{% endcomment %}
<p id="requirements">
  <strong>Requirements:</strong> Participants must have access to a desktop or laptop with an internet connection,
